...
<link rel="stylesheet" href="extraa.css">
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="#"><i class="fa fa-leanpub" aria-hidden="true"></i> iSchool</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="../logout.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In now</a> </li>
...
<div class="about-bottom">
	<div class="col-md-12 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div class="home-img"><img src="images/1.jpg" alt=""></div>
		</div>
		<div class="w3l_about_bottom_left_video" data-aos="zoom-in-down" data-aos-duration="2000" data-aos-delay="300">
			<h2 class="home-texts">WelCome To E Learning Website</h2>
			<p class="home-p">Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
			<a href="" class="home-btn">More</a>
...
<div class="about-top" id="about">
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			<div class="wthree-services-left" data-aos="fade-down"
     data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
				<img src="images/ab1.jpg" alt="">
			</div>
			<div class="wthree-services-right"  data-aos="fade-up"
     data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
				<img src="images/ab2.jpg" alt="">
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="col-md-5 wthree-about-grids" data-aos="zoom-in-left" data-aos-duration="3000" data-aos-delay="300">
...
<!-- //about -->
<!--stats-->
<div class="stats" id="stats" data-aos="zoom-in-up"
     data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
	<div class="container">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© Copyright - 2022 Scholarly. All rights reserved | Design by Developed By ASRT | <a href="../admin/logout.php">Admin Login</a></p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
